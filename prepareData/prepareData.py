...
def prepareAddPPBS(read,write):
    ...
    head = [["OCCUPATION", "p(SHE)", "p(HE)", "ppbs(gold)"]]
    with open(write, 'w', newline='', encoding="UTF-8") as csvfile:
        writer = csv.writer(csvfile, delimiter=";")
        writer.writerows(head)
...
prepareDistnctNames("../censusData/raw/ssbTopJentenavn80-23.csv", "../censusData/preparedData/ssbTopJentenavn80-23_prepared.csv")
prepareDistnctNames("../censusData/raw/ssbTopGuttenavn80-23.csv", "../censusData/preparedData/ssbTopGuttenavn80-23_prepared.csv")

prepareAddPPBS("../censusData/raw/utdanningnoLikestilling2023.csv", "../censusData/preparedData/utdanningnoLikestilling2023_prepared.csv")
